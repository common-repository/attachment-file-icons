<?php
/* 	
Plugin Name: Attachment File Icons (AF Icons)
Description: A plugin to display file type icons adjacent to files added to pages/posts/widgets. Feature to upload icons for different file types provided. Please refer plugin overview page for details.
